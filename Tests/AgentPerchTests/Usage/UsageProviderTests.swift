...
final class RuntimeUsageTokenSourceTests: XCTestCase {
    ...
    private let missingFile = URL(fileURLWithPath: "/nonexistent/agentperch/.credentials.json")
    ...
    private func claudeSource(
        ...
        ClaudeUsageSource(
            tokenSource: RuntimeUsageTokenSource(
                credentialsURL: URL(fileURLWithPath: "/nonexistent/agentperch/.credentials.json"),
...
final class UsageVisibilityStorageTests: XCTestCase {
    ...
    func testTheHiddenSetRoundTripsThroughStorageIncludingOddIdentifiers() throws {
        ...
        let defaults = try XCTUnwrap(UserDefaults(suiteName: "agentperch.usage-visibility.tests"))
        defaults.removePersistentDomain(forName: "agentperch.usage-visibility.tests")
    ...
    func testAnUnsetKeyIsNotHiddenEverything() throws {
        let defaults = try XCTUnwrap(UserDefaults(suiteName: "agentperch.usage-visibility.unset"))
        defaults.removePersistentDomain(forName: "agentperch.usage-visibility.unset")
