...
private enum GroundTruth {
    static let vibeNotch = "/Users/gzorrilla/Developer/personal/vibe-notch"
    ...
    static let claudeOne = ClaudeProcess(pid: 13_109, command: "claude", cwd: vibeNotch, tty: "ttys004")
    ...
    static let agentSpawnedCodexB = ClaudeProcess(pid: 64_673, command: "codex", cwd: vibeNotch, tty: nil)
...
final class LiveAgentScanTests: XCTestCase {
    ...
    func testTheRealProcessTableYieldsExactlyTheTwoHooklessSessions() {
        ...
        XCTAssertEqual(
            ...
            [
                ["Antigravity", GroundTruth.vibeNotch, "ttys002"],
...
final class GroundTruthSessionListTests: XCTestCase {
    ...
    func testTheMeasuredMachineProducesExactlyTwoHooklessRows() throws {
        ...
        let logs: [(name: String, workspace: String, ageMinutes: Double)] = [
            ...
            ("cli-0918.log", GroundTruth.vibeNotch, 5),
            ("cli-0827.log", "/", 56),
            ("cli-0826.log", "/", 56.5),
        ...
        XCTAssertEqual(
            ...
            [
                ["Antigravity", "vibe-notch", GroundTruth.vibeNotch, "ttys002"],
