...
/// `orderFrontRegardless()`-ed (DynamicNotch.swift:388, 400), never made key, while AgentPerch
...
/// first press without keying the panel and without activating AgentPerch — activating would pull
