...
/// ACTIVE app, and AgentPerch is an `.accessory` app whose panel is never made key while the user
...
/// the local one covers the case where AgentPerch itself happens to be active, and consumes the
