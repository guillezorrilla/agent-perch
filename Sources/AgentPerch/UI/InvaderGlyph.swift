...
extension Color {
    static let perchGreen = Color(red: 74 / 255, green: 222 / 255, blue: 128 / 255)
    static let perchAmber = Color(red: 245 / 255, green: 158 / 255, blue: 11 / 255)
    static let perchBlue = Color(red: 96 / 255, green: 165 / 255, blue: 250 / 255)
    static let perchGray = Color(red: 142 / 255, green: 142 / 255, blue: 147 / 255)
    static let perchCard = Color(red: 28 / 255, green: 28 / 255, blue: 30 / 255)
    static let perchBadge = Color(red: 44 / 255, green: 44 / 255, blue: 46 / 255)
    static let perchPanel = Color(red: 21 / 255, green: 21 / 255, blue: 21 / 255)
}
