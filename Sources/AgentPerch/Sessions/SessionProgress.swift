...
struct SessionProgress: Equatable, Sendable {
    ...
    mutating func apply(_ event: HookEvent) {
        ...
        case "PreToolUse":
            // A tool call with no prompt behind it means AgentPerch started mid-turn. The turn is
    ...
    private mutating func applyChecklist(_ event: HookEvent) {
        ...
        case "TaskUpdate":
            ...
            // AgentPerch attached mid-session and never saw the create — is dropped, not guessed.
