...
enum UpdateCheck {
    static let releasesPage = URL(string: "https://github.com/guillezorrilla/agent-perch/releases/latest")!
    static let latestReleaseAPI = URL(string: "https://api.github.com/repos/guillezorrilla/agent-perch/releases/latest")!
...
final class UpdateChecker: ObservableObject {
    ...
    static func postNotification(version: String) {
        ...
        content.title = "AgentPerch \(version) is available"
        ...
        UNUserNotificationCenter.current().add(UNNotificationRequest(
            identifier: "agentperch-update-\(version)",
            content: content,
            trigger: nil
        ))
    }
